    ...
    <div className="min-h-screen bg-[#F5F5F5] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
        ...
        <div className="space-y-5">
          <input type="text" className="bkash-input" placeholder="নাম বা নাম্বার" value={name} onChange={(e) => setName(e.target.value)} />
          <input type="text" className="bkash-input" placeholder="নাম্বার" value={number} onChange={(e) => setNumber(e.target.value)} />
          <input type="text" className="bkash-input" placeholder="টাকা" value={amount} onChange={(e) => setAmount(e.target.value)} />
          <input type="text" className="bkash-input" placeholder="সময়" value={time} onChange={(e) => setTime(e.target.value)} />
