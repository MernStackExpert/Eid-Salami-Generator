...
export default function EidSalami() {
  ...
  return (
    <div className="min-h-screen p-4 flex flex-col items-center bg-[#F5F5F5] font-sans">
      ...
      <div
        ref={receiptRef}
        className="md:w-[360px] w-full bg-white relative overflow-hidden flex flex-col shadow-sm "
      >
        ...
        <div className="bg-[#E2136E] text-white py-8 rounded-t-2xl mt-6 flex justify-between items-center px-6">
